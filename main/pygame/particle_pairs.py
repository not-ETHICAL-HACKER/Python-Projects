#! to improve perfoemance like a 100x i have decided to pair the particles from my other sims
#! the first wawy is randomised indices pairs
#! the other is linear pairs
import pygame
import numpy as np
